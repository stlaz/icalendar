...
class vDDDLists(object):
    ...
    @classmethod
    def from_ical(cls, ical, ltype=None, timezone=None):
        ...
        for ical_dt in ical_dates:
            out.append(ltype.from_ical(ical_dt, timezone=timezone))
        return out
...
class TypesFactory(CaselessDict):
    ...
    def from_ical(self, name, value, valuetype=None):
        ...
        if name.lower() in self.list_properties:
            ...
            decoded = vDDDLists.from_ical(value, ltype=type_class)
        else:
